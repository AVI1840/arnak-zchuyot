...
export const RIGHTS_DATABASE: Right[] = [
  ...
  {
    id: 'arnona_adult_disability_with_parents',
    title: 'הנחה בארנונה להורים שגר עמם בוגר עם נכות כללית (עד 33%)',
    provider: 'רשות מקומית',
    domain: 'utilities' as Domain,
    value_display: 'הנחה בארנונה עד 33% להורים שגר עמם בוגר עם נכות',
    eligibility_details: 'החל מינואר 2026, כל בוגר המקבל קצבת נכות כללית וגר בבית הוריו מזכה אותם בהנחה בארנונה של עד 33%, גם אם מעולם לא הוכר כילד נכה.',
    how_to_apply: 'יש לפנות לרשות המקומית עם אישור מהביטוח הלאומי על קבלת קצבת נכות כללית.',
    applicable_benefits: ['general_disability'] as BenefitType[],
    is_automatic: false,
    primary_display_priority: 2,
    estimated_value: 2000,
