...
export const RIGHTS_DATABASE: Right[] = [
  ...
  },
  {
    ...
    eligibility_details: 'מקבלי קצבת נכות כללית או נכות מעבודה או נכי פעולות איבה - ובעלי תעודת נכה מביטוח לאומי.\nשימו לב: מי שקיבל קצבת נכות כללית והזכאות הופסקה עקב הכנסותיו מעבודה – הוא ימשיך לקבל את ההטבות הנלוות להן היה זכאי, למשך 36 חודשים נוספים',
  ...
  },
  {
    ...
    title: 'פטור או הנחה מדמי הסכמה להעברת מקרקעין במינהל מקרקעי ישראל',
    provider: 'מינהל מקרקעי ישראל',
    domain: 'housing' as Domain,
    value_display: 'פטור או הנחה מדמי הסכמה להעברת מקרקעין במינהל מקרקעי ישראל',
  ...
  },
  {
    ...
    title: 'מגוון תוכניות ושירותים לילדים עם מוגבלות (מעונות יום, נופשונים ועוד)',
    provider: 'משרד הרווחה',
    domain: 'welfare' as Domain,
    value_display: 'מגוון תוכניות ושירותים לילדים עם מוגבלות (מעונות יום, נופשונים ועוד)',
  ...
  },
  {
    ...
    value_display: '50% הנחה עבור 400 קוט"ש ראשונים בתשלום חשבון החשמל החודשי',
    eligibility_details: 'מקבלי קצבת אזרח ותיק עם תוספת השלמת הכנסה וכן מקבלי קצבת אזרח ותיק עם השלמה לקצבת נכות.',
    how_to_apply: 'הביטוח הלאומי מעביר לחברת החשמל רשימות של מי שעשויים להיות זכאים להטבות. ההנחה אמורה להינתן באופן אוטומטי.\nשים לב שחשבון החשמל חייב להיות על שם הזכאי, ובתעריף ביתי בלבד. אם לזכאי יש יותר מחשבון חשמל אחד על שמו, עליו להסדיר את קבלת ההנחה מול חברת החשמל.',
    applicable_benefits: ['old_age_income_support'] as BenefitType[],
    is_automatic: true,
    primary_display_priority: 1,
    estimated_value: 2400,
  ...
  },
  {
    ...
    how_to_apply: 'את הבקשה ניתן לעשות באמצעות עריכת תיאום מס מקוון לשנה הנוכחית באתר רשות המיסים.\nאו להגיש בקשה בכתב בצירוף אישורים רלוונטיים לפקיד השומה הקרוב למקום מגוריך. לפרטים יש לפנות  לרשות המסים בטלפון 4954* או 02-5656400',
    applicable_benefits: ['work_injury'] as BenefitType[],
    is_automatic: false,
    primary_display_priority: 2,
    estimated_value: 15000,
  ...
  },
  {
    ...
    title: 'סיוע במימון מכשירי שיקום וניידות (תותבות, כסאות גלגלים, הליכונים ועוד)',
    provider: 'משרד הבריאות',
    domain: 'health' as Domain,
    value_display: 'סיוע במימון מכשירי שיקום וניידות (תותבות, כסאות גלגלים, הליכונים ועוד)',
  ...
  {
    id: 'work_absence_child_disability',
    title: 'היעדרות מעבודה עד 18 ימים בשנה על חשבון ימי מחלה לסיוע לילד/בוגר עם מוגבלות',
    provider: 'כללי',
    domain: 'welfare' as Domain,
    value_display: 'היעדרות מעבודה עד 18 ימים בשנה על חשבון ימי מחלה לסיוע לילד/בוגר עם מוגבלות',
  ...
  },
  {
    ...
    title: 'סל שיקום בבריאות הנפש',
    provider: 'משרד הבריאות',
    domain: 'health' as Domain,
    value_display: 'סל שיקום בבריאות הנפש',
  ...
  },
  {
    ...
    title: 'הנחה בעמלות בנק — 4 פעולות בפקיד יחושבו כפעולות ישירות',
    provider: 'בנקים',
    domain: 'financial' as Domain,
    value_display: 'הנחה בעמלות בנק',
    ...
    applicable_benefits: ['general_disability', 'work_injury', 'terror_victim', 'special_services', 'prisoners_of_zion'] as BenefitType[],
    is_automatic: false,
    primary_display_priority: 3,
    estimated_value: 1000,
    popularity_score: 60,
  ...
  // === אסירי ציון / משפחות שואה ===
  {
    id: 'arnona_holocaust',
    title: 'הנחה במסי ארנונה לאסיר ציון',
    provider: 'רשות מקומית',
    domain: 'utilities' as Domain,
    value_display: 'הנחה במסי ארנונה, גובה ההנחה נקבע על ידי הרשות המקומית',
    eligibility_details: 'מי שהוכר כאסיר ציון ומקבל לפחות את אחד התגמולים הבאים:\nתגמול לאסיר ציון נכה.\nתגמול לאסיר ציון על פי הכנסה.',
    how_to_apply: 'הביטוח הלאומי מעביר לרשויות המקומיות רשימות של מי שעשויים להיות זכאים להנחה.\nההנחה ניתנת על פי הכללים הקיימים של כל רשות מקומית, לפיכך לקבלת ההנחה יש לפנות לרשות המקומית.',
    applicable_benefits: ['prisoners_of_zion'] as BenefitType[],
    is_automatic: true,
    primary_display_priority: 1,
    estimated_value: 3500,
    popularity_score: 80,
  ...
  {
    id: 'medical_care_holocaust',
    title: 'טיפול רפואי ואביזרים רפואיים לאסיר ציון נכה',
    provider: 'קופת חולים',
    domain: 'health' as Domain,
    value_display: 'טיפול רפואי ואביזרים רפואיים לליקויים שהוכרו בוועדה הרפואית',
    eligibility_details: 'אסיר ציון נכה, זכאי לטיפול רפואי שיינתן באמצעות קופות החולים ובתי החולים שהוסמכו לתת שירות רפואי עבור הליקויים שהוכרו בוועדה הרפואית.',
    how_to_apply: 'יש לפנות לביטוח לאומי לקבלת התחייבות',
    applicable_benefits: ['prisoners_of_zion'] as BenefitType[],
    is_automatic: false,
    primary_display_priority: 3,
    estimated_value: 5000,
  ...
  {
    id: 'prisoner_zion_certificate',
    title: 'תעודת אסיר ציון',
    provider: 'משרד העלייה והקליטה',
    domain: 'welfare' as Domain,
    value_display: 'תעודת אסיר ציון — מהווה בסיס לקבלת הטבות נוספות',
    eligibility_details: 'מי שהוכר כאסיר ציון על ידי הרשות לאסירי ציון והרוגי מלכות.',
    how_to_apply: 'יש לפנות למשרד העלייה והקליטה לצורך אישור הזכאות והנפקת התעודה',
    applicable_benefits: ['prisoners_of_zion'] as BenefitType[],
    is_automatic: false,
    primary_display_priority: 3,
    estimated_value: 0,
  ...
  {
    id: 'arnona_righteous',
    title: 'הנחה במסי ארנונה לחסיד אומות עולם',
    provider: 'רשות מקומית',
    domain: 'utilities' as Domain,
    value_display: 'הנחה במסי ארנונה, את שיעור ההנחה קובעת הרשות המקומית',
    eligibility_details: 'מי שהוכר כחסיד אומות העולם ומתגורר בישראל',
    how_to_apply: 'הביטוח הלאומי מעביר לרשויות המקומיות רשימות של מי שעשויים להיות זכאים להנחה.\nההנחה ניתנת על פי הכללים הקיימים של כל רשות מקומית, לפיכך לקבלת ההנחה יש לפנות לרשות המקומית.',
    applicable_benefits: ['righteous_nations'] as BenefitType[],
    is_automatic: true,
    primary_display_priority: 1,
    estimated_value: 3500,
    popularity_score: 80,
  ...
  {
    id: 'health_services_righteous',
    title: 'פטור מהשתתפות עצמית במימון אשפוז סיעודי',
    provider: 'משרד הבריאות',
    domain: 'health' as Domain,
    value_display: 'פטור מהשתתפות עצמית במימון אשפוז סיעודי',
    eligibility_details: 'מי שהוכר כחסיד אומות העולם ומתגורר בישראל.',
    how_to_apply: 'ההטבה ניתנת באמצעות משרד הבריאות. למימוש הזכאות יש לפנות לקופת החולים בה חבר הזכאי.',
    applicable_benefits: ['righteous_nations'] as BenefitType[],
    is_automatic: false,
    primary_display_priority: 3,
  ...
  {
    id: 'health_tax_exempt_righteous',
    title: 'פטור מתשלום דמי ביטוח בריאות לחסיד אומות עולם',
    provider: 'ביטוח לאומי',
    domain: 'financial' as Domain,
    value_display: 'פטור מתשלום דמי ביטוח בריאות',
    eligibility_details: 'מי שהוכר כחסיד אומות העולם ומתגורר בישראל',
    how_to_apply: 'הפטור ניתן באופן אוטומטי על ידי הביטוח הלאומי',
    applicable_benefits: ['righteous_nations'] as BenefitType[],
    is_automatic: true,
    primary_display_priority: 3,
    estimated_value: 2400,
  ...
  {
    id: 'housing_righteous',
    title: 'זכאות לסיוע בפתרון דיור ובשכר דירה לחסיד אומות עולם',
    provider: 'משרד הבינוי והשיכון',
    domain: 'housing' as Domain,
    value_display: 'סיוע בפתרון דיור ובשכר דירה',
    eligibility_details: 'מי שהוכר כחסיד אומות העולם ומתגורר בישראל. קבלת ההטבה מותנית בתנאים נוספים.',
    how_to_apply: 'למימוש הזכאות יש לפנות אל המחלקה לשירותים חברתיים שבאזור מגוריו כדי לקבל סיוע במימוש זכויות הדיור ממשרד הבינוי והשיכון וחברות השיכון. לאחר מימוש זכויות אלו, ניתן לבדוק השלמת סיוע בשכר דירה.',
    applicable_benefits: ['righteous_nations'] as BenefitType[],
    is_automatic: false,
    primary_display_priority: 1,
  ...
  {
    id: 'housing_special',
    title: 'סיוע בתשלום שכר דירה או סיוע בדיור ציבורי',
    provider: 'משרד הבינוי והשיכון',
    domain: 'housing' as Domain,
    value_display: 'סיוע בתשלום שכר דירה או סיוע בדיור ציבורי',
  ...
  },
  {
    ...
    provider: 'משרד הבינוי והשיכון',
    domain: 'housing' as Domain,
    value_display: 'הלוואה לרכישת דירה או סיוע במימון שיפוצים',
  ...
  },
  {
    ...
    title: 'מגוון תוכניות שירותים ומענים לילדים עם מוגבלות',
    provider: 'משרד הרווחה',
    domain: 'welfare' as Domain,
    value_display: 'מגוון תוכניות שירותים ומענים לילדים עם מוגבלות',
  ...
  },
  {
    ...
    provider: 'כללי',
    domain: 'welfare' as Domain,
    value_display: 'היעדרות מעבודה עד 18 ימים בשנה על חשבון ימי מחלה',
    eligibility_details: 'מי שעובד לפחות שנה אצל אותו מעסיק והוא הורה או אפוטרופוס או הורה אומנה לילד או לבוגר עם מוגבלות קבועה שנמצא בחזקתו, והזכות להיעדרות מהעבודה באותו יום לא נוצלה על ידי ההורה השני.',
    how_to_apply: 'על העובד לפנות ישירות למעסיק לצורך מימוש הזכאות.\nהמעסיק רשאי לבקש מהעובד הצהרות ואישורים רלוונטיים.',
    applicable_benefits: ['child_disability', 'mobility', 'general_disability', 'work_injury', 'terror_victim'] as BenefitType[],
    is_automatic: false,
  ...
  },
  {
    ...
    provider: 'משרד הבינוי והשיכון',
    domain: 'housing' as Domain,
    value_display: 'סיוע במימון שיפוצים ושינויים בדירה',
  ...
  },
  {
    ...
    title: 'עזרה במימון מטפל/ת ל-50 שעות טיפול למשך חודשיים מיום השחרור מאשפוז',
    provider: 'קרן לרווחת ניצולי השואה',
    domain: 'welfare' as Domain,
    value_display: 'עזרה במימון מטפל/ת ל-50 שעות טיפול למשך חודשיים מיום השחרור מאשפוז',
    eligibility_details: 'ניצול שואה שהשתחרר מאשפוז בבית חולים ואינו מקבל גמלת סיעוד או גמלת שירותים מיוחדים מביטוח לאומי, ובתנאי שההכנסה החודשית של הניצול אינה עולה על סכום ההכנסה המקסימאלי שנקבע.',
  ...
  {
    id: 'water_old_age',
    title: 'טיפולי שיניים משמרים, מונעים ומשקמים במסגרת סל הבריאות',
    provider: 'קופת חולים',
    domain: 'health' as Domain,
    value_display: 'טיפולי שיניים משמרים, מונעים ומשקמים במסגרת סל הבריאות',
  ...
  // === הטבה חדשה 2026 — ארנונה לבוגרים עם נכות הגרים עם הוריהם ===
  {
    id: 'arnona_adult_disability_with_parents',
    title: 'הנחה בארנונה להורים שגר עמם בוגר עם נכות כללית',
    provider: 'רשות מקומית',
    domain: 'utilities' as Domain,
    value_display: 'הנחה בארנונה עד 33% להורים שגר עמם בוגר עם נכות',
    eligibility_details: 'החל מינואר 2026, כל בוגר המקבל קצבת נכות כללית והגר בבית הוריו מזכה אותם בהנחה בארנונה של עד 33%, גם אם מעולם לא הוכר כילד נכה. עד 2026 ההטבה הייתה מוגבלת רק למי שקיבל בעברו קצבת ילד נכה.',
    how_to_apply: 'יש לפנות לרשות המקומית עם אישור מהביטוח הלאומי על קבלת קצבת נכות כללית. ההנחה ניתנת על פי הכללים של כל רשות מקומית.',
    applicable_benefits: ['general_disability'] as BenefitType[],
    is_automatic: false,
    primary_display_priority: 2,
...
export function getEligibilityLevel(matchScore: number, hasMetrics: boolean = true): EligibilityLevel {
...
function checkRightEligibility(right: Right, context: EligibilityContext): { eligible: boolean; matchScore: number } {
  ...
  if (right.id === 'water_disability') {
    if (!hasMetrics) { matchScore = 70; } else if (metrics.medical_disability_pct >= 70) { matchScore = 95; } else { return { eligible: false, matchScore: 0 }; }
  }
  if (right.id === 'arnona_disability') {
    if (!hasMetrics) { matchScore = 70; } else if (metrics.incapacity_pct >= 75 || metrics.medical_disability_pct >= 90) { matchScore = 95; } else { return { eligible: false, matchScore: 0 }; }
  }
  if (right.id === 'tax_exemption_disability') {
    if (!hasMetrics) { matchScore = 60; } else if (metrics.medical_disability_pct >= 90) { matchScore = 95; } else { return { eligible: false, matchScore: 0 }; }
  }
  if (right.id === 'tax_purchase_disability') {
    if (!hasMetrics) { matchScore = 60; } else if (metrics.incapacity_pct >= 75 || metrics.medical_disability_pct >= 90) { matchScore = 95; } else { return { eligible: false, matchScore: 0 }; }
  }
  if (right.id === 'land_fees_disability') {
    if (!hasMetrics) { matchScore = 60; } else if (metrics.medical_disability_pct >= 80) { matchScore = 90; } else { return { eligible: false, matchScore: 0 }; }
  }
  if (right.id === 'housing_disability_96') {
    if (!hasMetrics) { matchScore = 60; } else if (metrics.incapacity_pct >= 75) { matchScore = 90; } else { return { eligible: false, matchScore: 0 }; }
  }
  if (right.id === 'nii_exempt_disability') {
    if (!hasMetrics) { matchScore = 60; } else if (metrics.incapacity_pct >= 75) { matchScore = 95; } else { matchScore = 50; }
  }
  if (right.id === 'tax_credit_disability') {
    if (!hasMetrics) { matchScore = 60; } else if (metrics.incapacity_pct >= 74) { matchScore = 90; } else { return { eligible: false, matchScore: 0 }; }
  }
  if (right.id === 'housing_disability') {
    if (!hasMetrics) { matchScore = 50; } else if (metrics.medical_disability_pct >= 40) { matchScore = 60; } else { return { eligible: false, matchScore: 0 }; }
  }
  if (right.id === 'bank_fees_disability') {
    if (!hasMetrics) { matchScore = 60; } else if (metrics.medical_disability_pct >= 40) { matchScore = 90; } else { return { eligible: false, matchScore: 0 }; }
  }
  // === שירותים מיוחדים ===
  if (right.id === 'water_special') {
    if (!hasMetrics) { matchScore = 70; } else if (metrics.special_services_rate >= 112) { matchScore = 95; } else { return { eligible: false, matchScore: 0 }; }
  }
  if (right.id === 'housing_special') {
    if (!hasMetrics) { matchScore = 50; } else if (metrics.special_services_rate >= 112) { matchScore = 60; } else { return { eligible: false, matchScore: 0 }; }
  }
  // === ניידות ===
  if (right.id === 'arnona_mobility') {
    if (!hasMetrics) { matchScore = 70; } else if (metrics.mobility_pct >= 90) { matchScore = 95; } else { return { eligible: false, matchScore: 0 }; }
  }
  if (right.id === 'tax_purchase_mobility') {
    if (!hasMetrics) { matchScore = 60; } else if (metrics.mobility_pct >= 50) { matchScore = 90; } else { return { eligible: false, matchScore: 0 }; }
  }
  if (right.id === 'housing_mobility') {
    if (metrics.uses_wheelchair) { matchScore = 90; } else { matchScore = 50; }
  }
  // === תחבורה ===
  if (right.id === 'transport_disability') {
    if (metrics.age >= 67) { return { eligible: false, matchScore: 0 }; } matchScore = 90;
  }
  if (right.id === 'transport_old_age') {
    if (metrics.age >= 67) { matchScore = 95; } else if (!hasMetrics) { matchScore = 70; } else { return { eligible: false, matchScore: 0 }; }
  }
  ...
  if (right.id === 'arnona_old_age') {
    if (benefits.includes('old_age_income_support') || metrics.is_income_support) { matchScore = 95; } else { matchScore = 80; }
  }
  if (['health_services_old_age_is', 'phone_old_age_is', 'electricity_old_age_is', 'housing_old_age_is', 'water_old_age_is'].includes(right.id)) {
    if (benefits.includes('old_age_income_support')) { matchScore = 95; } else if (metrics.is_income_support) { matchScore = 90; } else { return { eligible: false, matchScore: 0 }; }
  }
  if (right.id === 'water_old_age') {
    if (metrics.age >= 72) { matchScore = 95; } else if (!hasMetrics) { matchScore = 60; } else { return { eligible: false, matchScore: 0 }; }
  }
  // === שארים ===
  if (['electricity_survivors_is', 'housing_survivors_is', 'health_services_survivors_is', 'arnona_survivors_is', 'phone_survivors_is', 'water_survivors_is', 'arnona_survivors'].includes(right.id)) {
    if (benefits.includes('survivors_income_support')) { matchScore = 95; } else if (metrics.is_income_support) { matchScore = 90; } else { return { eligible: false, matchScore: 0 }; }
  }
  // === נכות מעבודה ===
  ...
  if (right.id === 'tax_purchase_work_injury') {
    if (!hasMetrics) { matchScore = 60; } else if (metrics.medical_disability_pct >= 90) { matchScore = 90; } else { return { eligible: false, matchScore: 0 }; }
  }
  if (right.id === 'legal_aid_work_injury' || right.id === 'life_insurance_work_injury') {
    if (!hasMetrics) { matchScore = 60; } else if (metrics.medical_disability_pct >= 20) { matchScore = 90; } else { return { eligible: false, matchScore: 0 }; }
  }
  if (right.id === 'nii_exempt_work_injury') {
    if (!hasMetrics) { matchScore = 60; } else if (metrics.medical_disability_pct >= 100) { matchScore = 95; } else { return { eligible: false, matchScore: 0 }; }
  }
  // === סיעוד ===
  if (right.id === 'electricity_nursing') {
    if (!hasMetrics) { matchScore = 60; } else if (metrics.nursing_level >= 5) { matchScore = 95; } else if (metrics.nursing_level === 4 && metrics.age >= 90) { matchScore = 95; } else if (metrics.nursing_level === 4) { matchScore = 50; } else { return { eligible: false, matchScore: 0 }; }
  }
  if (right.id === 'water_nursing') {
    if (!hasMetrics) { matchScore = 70; } else if (metrics.nursing_level >= 3) { matchScore = 95; } else { return { eligible: false, matchScore: 0 }; }
  }
  if (right.id === 'foreign_worker_nursing') {
    if (!hasMetrics) { matchScore = 60; } else if (metrics.nursing_level >= 3) { matchScore = 90; } else { return { eligible: false, matchScore: 0 }; }
  }
  if (right.id === 'hospitalization_nursing' || right.id === 'benefit_nursing') { matchScore = 50; }
  // === נפגעי איבה ===
  if (right.id === 'water_terror') {
    if (!hasMetrics) { matchScore = 60; } else if (metrics.medical_disability_pct >= 50) { matchScore = 95; } else { return { eligible: false, matchScore: 0 }; }
  }
  if (right.id === 'electricity_terror') {
    if (!hasMetrics) { matchScore = 60; } else if (metrics.medical_disability_pct >= 50) { matchScore = 95; } else { return { eligible: false, matchScore: 0 }; }
  }
  if (right.id === 'tax_purchase_terror') {
    if (!hasMetrics) { matchScore = 60; } else if (metrics.medical_disability_pct >= 19) { matchScore = 90; } else { return { eligible: false, matchScore: 0 }; }
  }
  if (right.id === 'land_fees_terror') {
    if (!hasMetrics) { matchScore = 60; } else if (metrics.medical_disability_pct >= 50) { matchScore = 90; } else { return { eligible: false, matchScore: 0 }; }
  }
  if (right.id === 'arnona_terror') {
    if (!hasMetrics) { matchScore = 70; } else if (metrics.medical_disability_pct >= 10) { matchScore = 95; } else { return { eligible: false, matchScore: 0 }; }
  }
  ...
  if (right.id === 'electricity_income_support') {
    if (benefits.includes('income_support') || metrics.is_income_support) { matchScore = 90; } else { return { eligible: false, matchScore: 0 }; }
  }
  if (right.id === 'arnona_income_support') { matchScore = 50; }
  if (right.id === 'electricity_alimony') { matchScore = 50; }
  // === ילד נכה ===
  if (right.id === 'tax_purchase_child') {
    if (!hasMetrics) { matchScore = 60; } else if (metrics.medical_disability_pct >= 100) { matchScore = 95; } else if (metrics.medical_disability_pct >= 90) { matchScore = 80; } else { return { eligible: false, matchScore: 0 }; }
  }
  if (right.id === 'pension_tax_child') {
    if (!hasMetrics) { matchScore = 60; } else if (metrics.medical_disability_pct >= 75) { matchScore = 90; } else { matchScore = 50; }
  }
