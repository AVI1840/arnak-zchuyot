...
export const RIGHTS_DATABASE: Right[] = [
  ...
  },
  {
    ...
    how_to_apply: 'ההטבה אינה ניתנת באופן אוטומטי.\nלבירור תנאי הזכאות ולהגשת בקשה לסיוע יש לפנות למשרד הבינוי והשיכון או לאחת החברות הבאות: אלונים (מקבוצת MGROUP), מילגם או מעוף.\nלידיעתכם, לאחר הגשת בקשה לאחת החברות, משרד השיכון פונה לביטוח הלאומי לקבלת מידע על זכאותכם.',
    applicable_benefits: ['old_age_income_support'] as BenefitType[],
    is_automatic: false,
    primary_display_priority: 1,
    estimated_value: 12000,
  ...
  },
  {
    ...
    title: 'עזרה במימון מטפל/ת ל-50 שעות טיפול למשך חודשיים מיום השחרור מאשפוז (ניצולי שואה)',
    provider: 'קרן לרווחת ניצולי השואה',
    domain: 'welfare' as Domain,
    value_display: 'עזרה במימון מטפל/ת ל-50 שעות טיפול למשך חודשיים מיום השחרור מאשפוז (ניצולי שואה)',
    eligibility_details: 'ניצול שואה שהשתחרר מאשפוז בבית חולים ואינו מקבל גמלת סיעוד או גמלת שירותים מיוחדים מביטוח לאומי, ובתנאי שההכנסה החודשית של הניצול אינה עולה על סכום ההכנסה המקסימאלי שנקבע על ידי הרשות לזכויות ניצולי השואה',
  ...
  },
  {
    ...
    title: 'סיוע במימון שיפוצים והתאמות דירה לניידות',
    provider: 'משרד הבינוי והשיכון',
    domain: 'housing' as Domain,
