...
const WIZARD_QUESTIONS: WizardQuestion[] = [
  // === נכות כללית ===
  {
    ...
    question: 'מהו אחוז הנכות הרפואית שנקבע לך בוועדה?',
    explanation: '70%+ מזכה בהנחה במים. 80%+ מזכה בהנחה בדמי הסכמה. 90%+ מזכה בפטור ממס הכנסה.',
    type: 'select',
  ...
  },
  {
    ...
    explanation: '74%+ מזכה בנקודות זיכוי מס. 75%+ מזכה בהנחה בארנונה, סיוע בדיור ופטור מדמי ביטוח.',
    type: 'select',
  ...
  // === אזרח ותיק ===
  {
    ...
    explanation: 'השלמת הכנסה מזכה בהנחה בחשמל, מים, טלפון, ארנונה מלאה ועוד.',
    type: 'toggle',
