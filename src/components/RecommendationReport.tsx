...
function buildReportText(
  ...
  lines.push('══════════════════════════════════════');
  lines.push('');
  lines.push('⚠️ מסמך זה הוא למטרות מידע בלבד ואינו מהווה אישור זכאות רשמי.');
  lines.push('יש לאמת כל הטבה מול הגורם המוסמך.');
  lines.push('');
  ...
  lines.push('המידע אינו מחייב ואינו מהווה אישור זכאות.');
  lines.push('══════════════════════════════════════');
      ...
      <Dialog open={showPreview} onOpenChange={setShowPreview}>
        <DialogContent className="max-w-2xl max-h-[85vh] overflow-y-auto" dir="rtl">
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-lg p-3 text-sm text-amber-800">
            ⚠️ מסמך זה הוא למטרות מידע בלבד ואינו מהווה אישור זכאות רשמי.
          </div>
